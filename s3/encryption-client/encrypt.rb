...
resp = s3.put_object(bucket:bucket, key:mykey, body:'handshake')
puts "PUT"
puts resp

resp = s3.get_object(bucket:bucket, key:mykey).body.read
puts "GET WITH KEY"
puts resp
...
resp = Aws::S3::Client.new.get_object(bucket:bucket, key:mykey).body.read
